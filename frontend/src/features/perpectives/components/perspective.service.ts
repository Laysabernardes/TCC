...
import api from "../../../service/api"; // Importa a instância central do Axios (ajuste o caminho se necessário)
...
export class PerspectiveService {
  ...
  static async getByProjectId(projectId: string): Promise<PerspectiveResponseType[]> {
    ...
    const response = await api.get(`/perspectives/project/${projectId}`);
    return response.data;
  }
